...
# qsub -N hwe_plot_Chr22_noEpsi -m e -M wlhsu@uw.edu -q bigmem.q /projects/QCpipeline/runRscript.sh /projects/wlhsu/src/hwe/jointHW/Chplot/hwe_plot_Chr22_noEpsi.R
...
fileName    <- "snp.annot.v04.noepsi.ch22.wlh.RData"
...
qq_outfile<-"/projects/wlhsu/plots/hwe/HardyWeinberg/asianAMF/ch22/qq_plot_hwe_Ch22_joint_noEpsi.png"
...
# (1) chromosome 22 - all
png("/projects/wlhsu/plots/hwe/HardyWeinberg/asianAMF/ch22/hwe_vs_exact_Ch22_joint_noEpsi.png",width=720, height=720)
...
png("/projects/wlhsu/plots/hwe/HardyWeinberg/asianAMF/ch22/hwe_vs_midp_Ch22_joint_noEpsi.png",width=720, height=720)
...
png("/projects/wlhsu/plots/hwe/HardyWeinberg/asianAMF/ch22/exact_vs_midp_Ch22_joint_noEpsi.png",width=720, height=720)
...
png("/projects/wlhsu/plots/hwe/HardyWeinberg/asianAMF/ch22/midp_vs_midp_Ch22_joint_noEpsi.png",width=720, height=720)
...
png("/projects/wlhsu/plots/hwe/HardyWeinberg/asianAMF/ch22/hwe_vs_exact_Ch22_joint_truncated_noEpsi.png",width=720, height=720)
plot(-log10(snp$hwe.asian.pval[snp$chromosome == 22]), -log10(snp$exact.pv.asian.jmf.ch22[snp$chromosome == 22]),
xlab="-log10(p-values) GWASTools Exact Test", ylab="-log10(p-values) HardyWeinberg Joint Exact Test",
...
png("/projects/wlhsu/plots/hwe/HardyWeinberg/asianAMF/ch22/hwe_vs_midp_Ch22_joint_truncated_noEpsi.png",width=720, height=720)
plot(-log10(snp$hwe.asian.pval[snp$chromosome == 22]), -log10(snp$midp.pv.asian.jmf.ch22[snp$chromosome == 22]),
xlab="-log10(p-values) GWASTools Exact Test", ylab="-log10(p-values) HardyWeinberg Joint Mid-P Test",
xlim=c(0,4), ylim=c(0,4),
...
png("/projects/wlhsu/plots/hwe/HardyWeinberg/asianAMF/ch22/exact_vs_midp_Ch22_joint_truncated_noEpsi.png",width=720, height=720)
plot(-log10(snp$exact.pv.asian.jmf.ch22[snp$chromosome == 22]), -log10(snp$midp.pv.asian.jmf.ch22[snp$chromosome == 22]),
xlab="-log10(p-values) HardyWeinberg Joint Exact Test", ylab="-log10(p-values) HardyWeinberg Joint Mid-P Test",
xlim=c(0,4), ylim=c(0,4),
...
png("/projects/wlhsu/plots/hwe/HardyWeinberg/asianAMF/ch22/midp_vs_midp_Ch22_joint_truncated_noEpsi.png",width=720, height=720)
plot(-log10(snp$midp.pval.asian[snp$chromosome == 22]), -log10(snp$midp.pv.asian.jmf.ch22[snp$chromosome == 22]),
xlab="-log10(p-values) HardyWeinberg Mid-P Test", ylab="-log10(p-values) HardyWeinberg Joint Mid-P Test",
xlim=c(0,4), ylim=c(0,4),
