#############
# Joint test for Hardy-Weinberg proportions in males and females --- Chromosome 22
#############


# qsub -N hwe_Chr22 -m e -M wlhsu@uw.edu -q bigmem.q /projects/QCpipeline/runRscript.sh /projects/wlhsu/src/hwe/jointHW/hwe_joint_Chr22.R
...
saveas(asian.Ch, "Chr22.jmf.pv.wlh.RData", "/projects/wlhsu/results/hwe/HardyWeinberg/asian/Autosome")
...
rownames(meta)[idx]    
meta["exact.pv.asian.jmf.ch22", "labelDescription"] <- "p-value from joint exact test for Hardy-Weinberg proportions in males and females on chromosome 22 in set of 352 hwe.asian.mcd=TRUE samples"
meta["midp.pv.asian.jmf.ch22", "labelDescription"] <- "p-value from joint mid-p test for Hardy-Weinberg proportions in males and females on chromosome 22 in set of 352 hwe.asian.mcd=TRUE samples"
...
head(pData(snp))
saveas(snp, "snp.annot.v04.ch22.wlh.RData", "/projects/wlhsu/results/hwe/HardyWeinberg/asian/Autosome")
