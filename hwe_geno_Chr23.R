...
# qsub -N hwe_Chr23 -m e -M wlhsu@uw.edu -q r420.q /projects/QCpipeline/runRscript.sh /projects/wlhsu/src/hwe/hwe_geno_Chr23.R
...
X <- snp.chr1[snp.chr1$chromosome == 23,]; dim(X)
head(pData(X),n=3)
...
saveas(df, "XChr.geno.v01.wlh.RData", "/projects/cidr/Peters_rep/wlhsu/results/hwe/HardyWeinberg")
